...
4. Добавлено в настройках кнопка проверки путей артов/токенов актеров на сцене(как одной, так и всех сцен). Поиск идет по имени актера, пока не смог отвязать от Babele
